export default {
  ...
  pageWhiteListRegexp: new RegExp(
    // Википедия:
    '^(?:Википедия:(?:.* запросы|Голосования/|Запросы|Заявки на |Изменение спам-листа|К восстановлению/|К объединению/|К оценке источников|К переименованию/|К посредничеству/|К разделению/|К удалению/|К улучшению/|Кандидаты в .*/|Обсуждение категорий/|Обсуждение правил/|Опросы/|Оспаривание|Проверка участников/|Просьба прокомментировать/|Рецензирование/|Снятие защиты|Установка защиты|Фильтр правок/Срабатывания|Форум[/ ])|' +
    // Проект:
