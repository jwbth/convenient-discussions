export default {
  ...
  pageWhiteListRegexp: new RegExp(
    // Википедия:
    '^(?:Википедия:(?:Форум[/ ]|Голосования/|Опросы/|Обсуждение правил/|Просьба прокомментировать/|Заявки на |Запросы|Кандидаты в .*/|К (?:удалению|восстановлению|объединению|переименованию|разделению|улучшению|оценке источников|посредничеству)/|Оспаривание|Рецензирование/|Проверка участников/|Фильтр правок/Срабатывания|.* запросы|К оценке источников|Установка защиты|Снятие защиты|Изменение спам-листа)|' +
    // Проект:
