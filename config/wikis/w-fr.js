export default /** @type {Partial<typeof import('../default').default>} */ ({
	messages: {
		...
		'discussiontools-topicsubscription-button-subscribe-tooltip':
			'{{GENDER:|}}Abonnez-vous pour recevoir les notifications sur les nouveaux commentaires.',
		'discussiontools-topicsubscription-button-unsubscribe': 'se désabonner',
		'discussiontools-topicsubscription-button-unsubscribe-tooltip':
			'{{GENDER:|}}Désabonnez-vous pour arrêter de recevoir les notifications pour de nouveaux commentaires.',
		...
		'discussiontools-topicsubscription-notify-subscribed-body':
			'{{GENDER:|}}Vous recevrez des notifications sur les nouveaux commentaires sur ce sujet.',
		'discussiontools-topicsubscription-notify-unsubscribed-title':
			'Vous êtes désabonné{{GENDER:||e}}.',
		'discussiontools-topicsubscription-notify-unsubscribed-body':
			'{{GENDER:|}}Vous ne recevrez plus de notifications sur les nouveaux commentaires sur ce sujet.',
		...
		'discussiontools-newtopicssubscription-button-subscribe-tooltip':
			'Abonnez-vous pour recevoir des notifications lorsque de nouveaux sujets sont lancés sur cette page.',
		...
		'discussiontools-newtopicssubscription-button-unsubscribe-tooltip':
			'Désabonnez-vous pour ne plus recevoir de notifications lorsque de nouveaux sujets sont lancés sur cette page.',
		'discussiontools-newtopicssubscription-notify-subscribed-title':
			'Vous êtes abonné{{GENDER:||e}} !',
		'discussiontools-newtopicssubscription-notify-subscribed-body':
			'{{GENDER:|}}Vous recevrez des notifications lorsque de nouveaux sujets seront lancés sur cette page.',
		...
		'discussiontools-newtopicssubscription-notify-unsubscribed-body':
			'{{GENDER:|}}Vous ne recevrez plus de notifications lorsque de nouveaux sujets sont lancés sur cette page.',
	},
	specialPageAliases: {
	...
	pairQuoteTemplates: [
		['Début citation bloc', 'Début de citation', 'Citation début', 'Début citation'],
		['Fin citation bloc', 'Fin de citation', 'Fin citation'],
	],
	outdentTemplates: ['retour indentation', 'RI', 'Retour chariot', 'RI:', 'Ri', 'Outdent'],
	clearTemplates: ['Clear'],
	reflistTalkTemplates: ['Références discussion', 'Reflist-talk', 'Reflist talk'],
	reflistTalkClasses: ['references-discussion'],
	noSignatureClasses: ['NavFrame'],
