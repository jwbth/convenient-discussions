declare global {
	namespace mw {
		namespace widgets {
			 ...
			 */
			class TitleInputWidget
				extends OO.ui.TextInputWidget
				implements mw.widgets.TitleWidget, OO.ui.mixin.LookupElement
			{
			...
			interface TitleInputWidget
				...
				on<K extends keyof TitleInputWidget.EventMap, A extends OO.ArgTuple = [], C = null>(
					...
					method: OO.EventHandler<
						C,
						(this: C, ...args: [...A, ...TitleInputWidget.EventMap[K]]) => void
					>,
					args?: A,
					context?: C,
				): this
				...
				once<K extends keyof TitleInputWidget.EventMap>(
					event: K,
					listener: (this: null, ...args: TitleInputWidget.EventMap[K]) => void,
				): this
				...
				emit<K extends keyof TitleInputWidget.EventMap>(
					event: K,
					...args: TitleInputWidget.EventMap[K]
				): boolean
				...
				emitThrow<K extends keyof TitleInputWidget.EventMap>(
					event: K,
					...args: TitleInputWidget.EventMap[K]
				): boolean
