...
class SpaciousCommentActions extends CommentActions {
	...
	/**
	 * Create a "Fix" button for spacious comments.
	 *
	 * @override
	 * @param {import('./Button').Action} action The action to perform when clicked.
	 * @returns {CommentButton} The created button.
	...
	static initPrototypes() {
		...
		this.prototypes.add(
			'goToParentButtonSvg',
			cd.utils.createSvg('1.142857em', '1.142857em', 20, 20).html(`<path d="M10 5l8 10H2z" />`)[0],
		)
		this.prototypes.add(
			'goToChildButtonSvg',
			cd.utils.createSvg('1.142857em', '1.142857em', 20, 20).html(`<path d="M10 15L2 5h16z" />`)[0],
		)
