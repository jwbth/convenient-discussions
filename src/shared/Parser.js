...
class Parser {
   ...
   * disabled DT) in `TalkPageBootProcess#processTargets()`. Unless the elements prove useful to CD
   * or other scripts, it's better to get rid of them rather than deal with them one by one while
   * parsing.
   */
