/**
 * Module that initializes the {@link convenientDiscussions} object.
 *
...
import { buildEditSummary, wrap, wrapDiffBody } from './utils';
...
Object.assign(cd, {
  ...
  /**
   * Collection of properties accessible from anywhere in the script that are not grouped in any
   * other way (incomplete list). "g" is for "global". Static (i.e., known from the beginning) ones
   * are declared in {@link module:staticGlobals}.
   *
   * @namespace g
   * @memberof convenientDiscussions
   */
  g: {
     ...
     * @memberof convenientDiscussions.g
     */
    commentHoveredBackgroundColor: '#f8f9fa',
     ...
     * @memberof convenientDiscussions.g
     */
    commentTargetBackgroundColor: '#fef6e7',
     ...
     * @memberof convenientDiscussions.g
     */
    commentTargetHoverBackgroundColor: '#fef2db',
     ...
     * @memberof convenientDiscussions.g
     */
    commentNewBackgroundColor: '#edffed',
     ...
     * @memberof convenientDiscussions.g
     */
    commentNewHoveredBackgroundColor: '#e4ffe4',
     ...
     * @memberof convenientDiscussions.g
     */
    commentOwnBackgroundColor: '#faf3fc',
     ...
     * @memberof convenientDiscussions.g
     */
    commentOwnHoveredBackgroundColor: '#f7edfb',
     ...
     * @memberof convenientDiscussions.g
     */
    commentDeletedBackgroundColor: '#fee7e6',
     ...
     * @memberof convenientDiscussions.g
     */
    commentDeletedHoveredBackgroundColor: '#fddbd9',
    ...
    /**
     * Popular elements that don't have the `display: inline` property in the default browser
     * styles.
     *
     * @type {string[]}
     * @memberof convenientDiscussions.g
    ...
    popularNotInlineElements: [
      'BLOCKQUOTE', 'DD', 'DIV', 'DL', 'DT', 'FIGURE', 'FIGCAPTION', 'FORM', 'H1', 'H2', 'H3', 'H4',
      'H5', 'H6', 'HR', 'INPUT', 'LI', 'LINK', 'OL', 'P', 'PRE', 'STYLE', 'TABLE', 'TBODY', 'TR',
      'TH', 'TD', 'UL'
    ],
